...
Here we plot yearly Great Salt Lake elevations measured as feet above sea level, with yearly agricultural water usage below. We also added a line at 4198 feet - this number represents the minimum water level needed to support a healthy ecosystem. Clearly, the GSL has been trending down for years now and lies well below the healthy minimum needed.
