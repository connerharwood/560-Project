...
Despite a lengthy and exhaustive cleaning process, during our explanatory stage we frequently encountered issues with our data that needed attention and further cleaning. The data seem to have significant limitations that we hope to better address as we continue with our analyis.
...
![]("~/560-Project/exploratory/output/gslLevels.png")
...
![]("~/560-Project/exploratory/output/waterUse_byType.png")
...
![]("~/560-Project/exploratory/output/precip_waterUsage.png")
...
![]("~/560-Project/exploratory/output/perCapita_usage.png")
