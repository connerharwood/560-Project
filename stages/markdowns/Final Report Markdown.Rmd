...
$$gslvolume_t = \beta_0 + \beta_1 agricultural_{t-1} + \beta_2 commercial_{t-1} + \beta_3 domestic_{t-1}+ \beta_4 industrial_{t-1} + \beta_5 irrigation_{t-1} + \beta_6 power_{t-1} + \beta_7 watersupply{t-1} + \beta_8 population_{t-1} + \beta_9 precipitation_{t-1} + u_t$$
