...
We restricted our dataset to 1996-2014. The overall data from 1959-2022 contained inconsistencies in number of water users reporting. Some years had drastic spikes in number of users, which can likely be explained by changing standards and laws on reporting. For example, in 2015 the Utah Division of Water Rights enacted [Rule R655-17](https://adminrules.utah.gov/public/rule/R655-17/Current%20Rules) to strengthen reporting requirements. The data shows a sharper increase in number of users reporting after this was implemented, so years before 2015 will not be consistent with this period. To restrict our data to the most complete and consistent reporting for most use types while achieving a longer study time frame, we found that the period 1996-2014 had a steady upward trend in number of users reporting. This is most likely due to more water rights being obtained rather than more water users choosing to report. Our appendix includes graphs showing these trends. "Sewage Treatment" and "Mining" were not consistent during this period so we filtered them out. Overall, the convoluted standards and laws for water reporting meant that we had to make judgement calls to select the best years for study. We are confident in our decision here.
...
Great Salt Lake water levels, measured as elevation in feet above sea level, show a consistent downward trend over time. The minimum level needed for a healthy lake has been repeatedly estimated to be at about 4,198 feet. The GSL has been well below this level since 2002, showing no signs of returning to it.
